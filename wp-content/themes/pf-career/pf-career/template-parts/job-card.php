<?php
/**
 * Template part for displaying individual job cards
 *
    ...
    <div class="job-card-header">
        <div class="job-card-header-cnt">
            ...
            <div class="job-location">
                <button class="save-button" data-job-id="<?php echo get_the_ID(); ?>">
        ...
        ?>
        <span class="job-department"><?php echo $department; ?></span>
    </div>
    <div class="job-card-body">
        <?php echo wp_trim_words(get_the_content(), 60, '...'); ?>
    </div>
    <div class="job-card-footer">
        <a href="<?php echo get_permalink(); ?>" class="ftr-btn">
            Read More
            <svg width="12" height="11" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10.7929 0H11.4515V10.2068H10.1343V2.24832L1.71022 10.6724L0.779053 9.74125L9.2027 1.31715H1.24464V0H10.7929Z" fill="#333333" />
            </svg>
        </a>
    </div>
</div>
