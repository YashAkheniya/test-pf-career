<?php
/**
 * Template part for displaying the jobs departments slider
 *
...
<div class="jobs-departments-slider">
        ...
        <div class="slider-slide">
            <div class="department-card">
                ...
                <div class="card-footer">
                    <span class="job-count"><?php echo $job_count . ' job' . ($job_count != 1 ? 's' : ''); ?></span>
