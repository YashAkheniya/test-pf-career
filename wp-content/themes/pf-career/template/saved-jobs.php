...
?>
<div class="career-ui save-jobs">
    <div class="search-job-filter">
        <div class="sj-title">
            <h1>Save Jobs</h1>
        </div>
    </div>
    <div class="save-job-cards-filter">
        <div class="job-list-cards">
            ...
            if ($jobs_posts_query->have_posts()) {
                ...
                while ($jobs_posts_query->have_posts()) {
                    ...
                    ?>
                    <div class="job-card" data-job-id="<?= get_the_ID() ?>">
                        <div class="job-card-header">
                            <div class="job-card-header-cnt">
                                ...
                                <div class="job-location">
                                    <button class="delete-button" data-job-id="<?= get_the_ID() ?>">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g opacity="0.75">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M8.33329 3.125C8.21823 3.125 8.12496 3.21827 8.12496 3.33333L8.12496 4.375H11.875L11.875 3.33333C11.875 3.21827 11.7817 3.125 11.6666 3.125H8.33329ZM13.125 4.375L13.125 3.33333C13.125 2.52792 12.472 1.875 11.6666 1.875H8.33329C7.52788 1.875 6.87496 2.52792 6.87496 3.33333L6.87496 4.375H2.91663V5.625H4.30347V16.25C4.30347 16.8578 4.54491 17.4407 4.97469 17.8705C5.40446 18.3002 5.98735 18.5417 6.59514 18.5417H13.4048C14.0126 18.5417 14.5955 18.3002 15.0252 17.8705C15.455 17.4407 15.6964 16.8578 15.6964 16.25V5.625H17.0833V4.375H13.125ZM14.4464 5.625H5.55347V16.25C5.55347 16.5263 5.66322 16.7912 5.85857 16.9866C6.05392 17.1819 6.31887 17.2917 6.59514 17.2917H13.4048C13.681 17.2917 13.946 17.1819 14.1414 16.9866C14.3367 16.7912 14.4464 16.5263 14.4464 16.25V5.625ZM7.70829 15V8.33333H8.95829V15H7.70829ZM11.0416 15V8.33333H12.2916V15H11.0416Z"
                                                    fill="#757575"></path>
                                            </g>
                                        </svg>
                                    </button>
        ...
        <div class="no-job-section">
            <div class="no-job-records-found">
                <div class="job-card-for-no-record">
                    <p>You haven’t saved any jobs yet.</p>
                    <a type="button" href="/job-search" class="go-to-serach-page-btn">Search</a>
                </div>
            </div>
        </div>
    </div>
